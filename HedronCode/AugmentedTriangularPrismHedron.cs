...
{
    class AugmentedTriangularPrismHedron : HedronBase
    {
       public AugmentedTriangularPrismHedron()
       {
                   Name = "AugmentedTriangularPrism";
         ...
         Vertex.Add(6, new HVector(0.49789095789068, 0.862372435695794, 0));
