...
{
    class PentagonalOrthobicupolaHedron : HedronBase
    {
       public PentagonalOrthobicupolaHedron()
       {
                   Name = "PentagonalOrthobicupola";
         ...
         Vertex.Add(7, new HVector(0.262865556059567, 0.809016994374947, 0.525731112119134));
         ...
         Vertex.Add(13, new HVector(-0.688190960235587, -0.5, 0.525731112119134));
         Vertex.Add(14, new HVector(-0.688190960235587, 0.5, -0.525731112119134));
