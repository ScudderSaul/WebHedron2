...
{
    class CubeOctahedronCompoundHedron : HedronBase
    {
       public CubeOctahedronCompoundHedron()
       {
                   Name = "CubeOctahedronCompound";
         ...
         Vertex.Add(8, new HVector(0, 1, 0));
         ...
         Vertex.Add(13, new HVector(1, 0, 0));
