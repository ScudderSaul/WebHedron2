...
{
    class CumulatedTetrahedronHedron : HedronBase
    {
       public CumulatedTetrahedronHedron()
       {
                   Name = "CumulatedTetrahedron";

         Vertex.Add(0, new HVector(-0.962250448649376, 0, 0.340206908719886));
         ...
         Vertex.Add(3, new HVector(0, 0, -1.02062072615966));
