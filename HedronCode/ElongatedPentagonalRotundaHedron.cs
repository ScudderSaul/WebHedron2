...
{
    class ElongatedPentagonalRotundaHedron : HedronBase
    {
       public ElongatedPentagonalRotundaHedron()
       {
                   Name = "ElongatedPentagonalRotunda";
         ...
         Vertex.Add(4, new HVector(-0.951056516295154, -1.30901699437495, -1));
         Vertex.Add(5, new HVector(-0.951056516295154, -1.30901699437495, 0));
         Vertex.Add(6, new HVector(-0.951056516295154, 1.30901699437495, -1));
         Vertex.Add(7, new HVector(-0.951056516295154, 1.30901699437495, 0));
         Vertex.Add(8, new HVector(0.951056516295154, -1.30901699437495, -1));
         Vertex.Add(9, new HVector(0.951056516295154, -1.30901699437495, 0));
         Vertex.Add(10, new HVector(0.951056516295154, 1.30901699437495, -1));
         Vertex.Add(11, new HVector(0.951056516295154, 1.30901699437495, 0));
         Vertex.Add(12, new HVector(-1.53884176858763, -0.5, -1));
         Vertex.Add(13, new HVector(-1.53884176858763, -0.5, 0));
         Vertex.Add(14, new HVector(-1.53884176858763, 0.5, -1));
         Vertex.Add(15, new HVector(-1.53884176858763, 0.5, 0));
         Vertex.Add(16, new HVector(1.53884176858763, -0.5, -1));
         Vertex.Add(17, new HVector(1.53884176858763, -0.5, 0));
         Vertex.Add(18, new HVector(1.53884176858763, 0.5, -1));
