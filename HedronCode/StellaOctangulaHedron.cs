...
{
    class StellaOctangulaHedron : HedronBase
    {
       public StellaOctangulaHedron()
       {
                   Name = "StellaOctangula";

         Vertex.Add(0, new HVector(0, 0, -0.612372435695794));
         Vertex.Add(1, new HVector(0, 0, 0.612372435695794));
         Vertex.Add(2, new HVector(-0.577350269189626, 0, 0.204124145231932));
         ...
         Vertex.Add(6, new HVector(0.288675134594813, 0.5, 0.204124145231932));
