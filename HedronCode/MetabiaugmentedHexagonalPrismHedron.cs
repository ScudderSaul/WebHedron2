...
{
    class MetabiaugmentedHexagonalPrismHedron : HedronBase
    {
       public MetabiaugmentedHexagonalPrismHedron()
       {
                   Name = "MetabiaugmentedHexagonalPrism";
         ...
         Vertex.Add(12, new HVector(-1.36237243569579, 0.786566092485493, 0));
